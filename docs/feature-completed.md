...
| 2026-07-24 | `web-feed-topics-sources` | Elegant feed, topics, sources UI | — | editorial web feed/topics/sources/settings; Issues API 403 so no parent issue link |
...
| ID | Feature | Completed | Spec | Notes |
|----|---------|-----------|------|-------|
| `web-feed-topics-sources` | Elegant feed, topics, sources UI | 2026-07-24 | `docs/architecture.md` | editorial web feed/topics/sources/settings; Issues API 403 so no parent issue link |
